...
class SoftwareCategoryImportForm extends Form implements LazyRenderable
{
    use LazyWidget;
    ...
    public function form()
    {
        $this->file('file', trans('main.file'))
            ...
            ->uniqueName()
            ->required()
            ->help(trans('main.software_category_import_file_help'));
    }
}
