<template>
    <view :class="[disabled ? 'u-slider--disabled' : '']" :style="{
		backgroundColor: inactiveColor
	}" class="u-slider" @tap="onClick">
        <view
            :style="[
				barStyle,
				{
            ...
            class="u-slider__gap"
        >
            <view class="u-slider__button-wrap" @touchcancel="onTouchEnd"
                  @touchend="onTouchEnd" @touchmove="onTouchMove"
                  @touchstart="onTouchStart">
                <slot v-if="$slots.default  || $slots.$default"/>
                <view v-else :style="[blockStyle, {
					height: blockWidth + 'rpx',
					width: blockWidth + 'rpx',
					backgroundColor: blockColor
				}]" class="u-slider__button"></view>
            </view>
        </view>
    </view>
</template>
