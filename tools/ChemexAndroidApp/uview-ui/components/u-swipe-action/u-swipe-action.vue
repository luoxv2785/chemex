<template>
    <view class="">
        <movable-area :style="{ backgroundColor: bgColor }" class="u-swipe-action">
            <movable-view
                :disabled="disabled"
                :style="{
            ...
            >
                ...
                <view v-for="(item, index) in options" v-if="showBtn" :key="index" :style="[btnStyle(item.style)]"
                      class="u-swipe-del" @tap.stop="btnClick(index)">
