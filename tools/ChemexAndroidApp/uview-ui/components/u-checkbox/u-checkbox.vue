<template>
    <view :style="[checkboxStyle]" class="u-checkbox">
        <view :class="[iconClass]" :style="[iconStyle]" class="u-checkbox__icon-wrap" @tap="toggle">
            <u-icon :color="iconColor" :size="checkboxIconSize" class="u-checkbox__icon-wrap__icon"
                    name="checkbox-mark"/>
        </view>
        <view :style="{
			fontSize: $u.addUnit(labelSize)
		}" class="u-checkbox__label" @tap="onClickLabel">
            <slot/>
        </view>
    </view>
</template>
