<template>
    <view class="u-countdown">
        <view v-if="showDays && (hideZeroDay || (!hideZeroDay && d != '00'))" :style="[itemStyle]"
              class="u-countdown-item">
            <view :style="[letterStyle]" class="u-countdown-time">
                {{ d }}
            </view>
        </view>
        <view
        ...
        <view v-if="showHours" :style="[itemStyle]" class="u-countdown-item">
            <view :style="{ fontSize: fontSize + 'rpx', color: color}" class="u-countdown-time">
                {{ h }}
            </view>
        </view>
        <view
        ...
        <view v-if="showMinutes" :style="[itemStyle]" class="u-countdown-item">
            <view :style="{ fontSize: fontSize + 'rpx', color: color}" class="u-countdown-time">
                {{ i }}
            </view>
        </view>
        ...
        <view v-if="showSeconds" :style="[itemStyle]" class="u-countdown-item">
            <view :style="{ fontSize: fontSize + 'rpx', color: color}" class="u-countdown-time">
                {{ s }}
            </view>
        </view>
