<template>
    <view
        ...
        @tap="click"
    >
        <u-icon v-if="icon" :custom-style="iconStyle" :name="icon" :size="iconSize"
                class="u-cell__left-icon-wrap"></u-icon>
        ...
        <u-icon v-if="arrow" :style="[arrowStyle]" class="u-icon-wrap u-cell__right-icon-wrap"
