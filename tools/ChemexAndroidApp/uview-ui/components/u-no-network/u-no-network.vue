<template>
    <view v-if="!isConnected" :style="{'z-index': uZIndex}" class="u-no-network" @touchmove.stop.prevent="() => {}">
        <view class="u-inner">
            <image :src="image" class="u-error-icon" mode="widthFix"></image>
            <view class="u-tips">
                {{ tips }}
            </view>
            ...
            <!-- #endif -->
            <view :hover-stay-time="150" class="u-retry" hover-class="u-retry-hover" @tap="retry">
                重试
            </view>
        </view>
    </view>
