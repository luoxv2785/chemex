<template>
    <view :class="[value == true ? 'u-switch--on' : '', disabled ? 'u-switch--disabled' : '']" :style="[switchStyle]"
          class="u-switch"
          @tap="onClick">
        <view :style="{
            ...
            <u-loading :color="loadingColor" :show="loading" :size="size * 0.6" class="u-switch__loading"/>
        </view>
    </view>
</template>
