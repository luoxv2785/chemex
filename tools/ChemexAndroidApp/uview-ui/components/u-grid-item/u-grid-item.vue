<template>
    <view :hover-class="parentData.hoverClass" :hover-stay-time="200"
          :style="{
			background: bgColor,
			width: width,
		}" class="u-grid-item" @tap="click">
        <view :class="[parentData.border ? 'u-border-right u-border-bottom' : '']" :style="[customStyle]"
