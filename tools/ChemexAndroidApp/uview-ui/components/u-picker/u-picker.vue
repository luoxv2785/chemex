    ...
    <u-popup v-model="value" :maskCloseAble="maskCloseAble" :popup="false" :safeAreaInsetBottom="safeAreaInsetBottom" :z-index="uZIndex"
        ...
        <view class="u-datetime-picker">
            ...
            <view class="u-picker-body">
                ...
                <picker-view v-else-if="mode == 'multiSelector'" :value="valueArr" class="u-picker-view"
                             @change="change" @pickend="pickend" @pickstart="pickstart">
...
.u-picker-header::after {
    content: '';
    position: absolute;
    border-bottom: 1 rpx solid #eaeef1;
