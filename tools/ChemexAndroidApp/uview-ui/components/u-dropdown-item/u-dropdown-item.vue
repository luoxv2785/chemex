<template>
    <view v-if="active" class="u-dropdown-item" @touchmove.stop.prevent="() => {}" @tap.stop.prevent="() => {}">
        <block v-if="!$slots.default && !$slots.$default">
            <scroll-view :style="{
                ...
                <view class="u-dropdown-item__options">
                    <u-cell-group>
                        <u-cell-item v-for="(item, index) in options" :key="index" :arrow="false"
                                     :title="item.label"
                                     :title-style="{
							color: value == item.value ? activeColor : inactiveColor
						}" @click="cellClick(item.value)">
                            <u-icon v-if="value == item.value" :color="activeColor" name="checkbox-mark"
                                    size="32"></u-icon>
                        </u-cell-item>
                    </u-cell-group>
                </view>
