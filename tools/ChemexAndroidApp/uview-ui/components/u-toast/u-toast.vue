<template>
    <view :class="[isShow ? 'u-show' : '', 'u-type-' + tmpConfig.type, 'u-position-' + tmpConfig.position]"
          :style="{
		zIndex: uZIndex
	}" class="u-toast">
        <view class="u-icon-wrap">
            <u-icon v-if="tmpConfig.icon" :color="tmpConfig.type" :name="iconName" :size="30" class="u-icon"></u-icon>
        </view>
